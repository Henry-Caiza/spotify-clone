    ...
    return (React.createElement("div", { className: tailwind_merge_1.twMerge("h-fit bg-gradient-to-b from-emerald-800 p-6", className) },
        React.createElement("div", { className: "w-full mb-4 flex items-center justify-between" },
            ...
            React.createElement("div", { className: "flex justify-between items-center gap-x-4" }, user ? (React.createElement("div", { className: "flex gap-x-4 items-center" },
                ...
                React.createElement(Button_1["default"], { onClick: function () { return router.push('/account'); }, className: "bg-white " + (((_b = dataUser.userDetails) === null || _b === void 0 ? void 0 : _b.avatar_url) ? 'p-0' : 'p-3') }, ((_c = dataUser.userDetails) === null || _c === void 0 ? void 0 : _c.avatar_url) ? (React.createElement("img", { src: (_d = dataUser.userDetails) === null || _d === void 0 ? void 0 : _d.avatar_url, alt: "avatar", className: "w-10 h-10 rounded-full" })) : (React.createElement("div", { className: "bg-[#613eedc4] w-10 h-10 justify-center rounded-full flex items-center" },
